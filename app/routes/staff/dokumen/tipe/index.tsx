...
export async function loader({ request, params, context }: Route.LoaderArgs) {
  ...
  // get Main data ===========
  const dokumens = await getAllDokumenByTipe(user?.idSubBidang!, user?.idUser!, params.tipeDokumen, {
  ...
  const skill =
    params.tipeDokumen === "Knowledge" ? await getAllSkill(user?.idSubBidang!, activeFilter.team) : undefined;
  const filterData = {
    teams,
    layanan,
    skill,
